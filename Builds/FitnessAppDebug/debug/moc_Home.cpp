...
QT_MOC_LITERAL(1, 5, 19), // "waterAmmountChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12) // "waterAmmount"

    },
    "Home\0waterAmmountChanged\0\0waterAmmount"
};
...
void Home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->waterAmmountChanged(); break;
        default: ;
        }
        ...
        {
            using _t = void (Home::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Home::waterAmmountChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->m_WaterAmmount; break;
        default: break;
        }
        ...
        switch (_id) {
        case 0:
            if (_t->m_WaterAmmount != *reinterpret_cast< int*>(_v)) {
                _t->m_WaterAmmount = *reinterpret_cast< int*>(_v);
                Q_EMIT _t->waterAmmountChanged();
            }
            break;
        default: break;
        }
